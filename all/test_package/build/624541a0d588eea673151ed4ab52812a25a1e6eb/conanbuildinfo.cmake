...
###  CONFU_JSON
#################
set(CONAN_CONFU_JSON_ROOT "/home/walde/.conan/data/confu_json/0.0.1/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_CONFU_JSON "/home/walde/.conan/data/confu_json/0.0.1/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include")
set(CONAN_LIB_DIRS_CONFU_JSON )
set(CONAN_BIN_DIRS_CONFU_JSON )
set(CONAN_RES_DIRS_CONFU_JSON )
set(CONAN_SRC_DIRS_CONFU_JSON )
set(CONAN_BUILD_DIRS_CONFU_JSON "/home/walde/.conan/data/confu_json/0.0.1/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
...
###  BOOST
#################
set(CONAN_BOOST_ROOT "/home/walde/.conan/data/boost/1.76.0/_/_/package/524ea35a8120baabdde02483add58d81bf541327")
set(CONAN_INCLUDE_DIRS_BOOST "/home/walde/.conan/data/boost/1.76.0/_/_/package/524ea35a8120baabdde02483add58d81bf541327/include")
set(CONAN_LIB_DIRS_BOOST )
set(CONAN_BIN_DIRS_BOOST )
set(CONAN_RES_DIRS_BOOST )
set(CONAN_SRC_DIRS_BOOST )
set(CONAN_BUILD_DIRS_BOOST "/home/walde/.conan/data/boost/1.76.0/_/_/package/524ea35a8120baabdde02483add58d81bf541327/")
...
set(CONAN_DEPENDENCIES confu_json boost)
...
set(CONAN_INCLUDE_DIRS "/home/walde/.conan/data/confu_json/0.0.1/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include"
			"/home/walde/.conan/data/boost/1.76.0/_/_/package/524ea35a8120baabdde02483add58d81bf541327/include" ${CONAN_INCLUDE_DIRS})
...
set(CONAN_CMAKE_MODULE_PATH "/home/walde/.conan/data/confu_json/0.0.1/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/"
			"/home/walde/.conan/data/boost/1.76.0/_/_/package/524ea35a8120baabdde02483add58d81bf541327/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    set(_CONAN_PKG_LIBS_CONFU_JSON_DEPENDENCIES "${CONAN_SYSTEM_LIBS_CONFU_JSON} ${CONAN_FRAMEWORKS_FOUND_CONFU_JSON} CONAN_PKG::boost")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_CONFU_JSON}" "${CONAN_LIB_DIRS_CONFU_JSON}"
                                  ...
                                  "" confu_json)
    set(_CONAN_PKG_LIBS_CONFU_JSON_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_CONFU_JSON_DEBUG} ${CONAN_FRAMEWORKS_FOUND_CONFU_JSON_DEBUG} CONAN_PKG::boost")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_CONFU_JSON_DEBUG}" "${CONAN_LIB_DIRS_CONFU_JSON_DEBUG}"
                                  ...
                                  "debug" confu_json)
    set(_CONAN_PKG_LIBS_CONFU_JSON_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_CONFU_JSON_RELEASE} ${CONAN_FRAMEWORKS_FOUND_CONFU_JSON_RELEASE} CONAN_PKG::boost")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_CONFU_JSON_RELEASE}" "${CONAN_LIB_DIRS_CONFU_JSON_RELEASE}"
                                  ...
                                  "release" confu_json)
    set(_CONAN_PKG_LIBS_CONFU_JSON_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_CONFU_JSON_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_CONFU_JSON_RELWITHDEBINFO} CONAN_PKG::boost")
    ...
    set(_CONAN_PKG_LIBS_CONFU_JSON_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_CONFU_JSON_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_CONFU_JSON_MINSIZEREL} CONAN_PKG::boost")
    ...
    set(CONAN_TARGETS CONAN_PKG::confu_json CONAN_PKG::boost)
